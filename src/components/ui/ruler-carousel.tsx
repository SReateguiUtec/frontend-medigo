...
const RulerLines = ({
    ...
    for (let i = 0; i < totalLines; i++) {
        ...
        if (isCenter) {
            height = "h-8";
            color = "bg-blue-600 dark:bg-white";
        } else if (isFifth) {
            height = "h-4";
            color = "bg-blue-600 dark:bg-white";
        }
...
export function RulerCarousel({
    ...
    return (
        <div className="w-full h-[150px] flex flex-col items-center justify-center bg-transparent">
                        ...
                        {infiniteItems.map((item, index) => {
                            ...
                            return (
                                <motion.button
                                    ...
                                    className={`text-4xl md:text-6xl font-bold whitespace-nowrap cursor-pointer flex items-center justify-center ${isActive
                                        ? "text-gray-900"
