...
const SERVICES = [
    {
        id: "01",
        title: "Unete a nuestra plataforma",
        description:
    ...
    {
        id: "02",
        title: "Expande tu alcance profesional",
        description: "Conecta con pacientes de todo el país y aumenta tu visibilidad.",
        image:
            "/medicosnetworking.png",
    },
    {
        id: "03",
        title: "Branding",
        description:
            "Define tu marca personal y profesional con nuestra plataforma.",
        image:
            "/medicosbranding.png",
    },
];
...
export function VerticalTabs() {
    ...
    return (
        <section className="w-full bg-background pt-2 md:pt-4 lg:pt-8 pb-8 md:pb-16 lg:pb-24">
            <div className="w-full px-4 md:px-8 lg:px-12 xl:px-20 mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    {/* Left Column: Content */}
                    <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 pt-4">
                        <div className="space-y-1 mb-12 pl-6 md:pl-8">
                        ...
                        <div className="flex flex-col space-y-0 pl-6 md:pl-8">
                            {SERVICES.map((service, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="absolute left-[-16px] md:left-[-24px] top-0 bottom-0 w-[2px] bg-gray-300">
                                            {isActive && (
                                                <motion.div
                                        ...
                                        <div className="flex flex-col gap-2 flex-1">
                                            ...
                                            <AnimatePresence mode="wait">
                                                {isActive && (
                                                    ...
                                                    >
                                                        <p className="text-gray-500 text-sm md:text-base font-normal leading-relaxed max-w-sm pb-2">
                                                            {service.description}
                                                        </p>
                                                    </motion.div>
                                                )}
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-end h-full order-1 lg:order-2">
                        ...
                        >
                            <div className="relative aspect-4/5 md:aspect-4/3 lg:aspect-16/11 rounded-3xl md:rounded-[2.5rem] overflow-hidden bg-muted/30">
                                <AnimatePresence
                                    initial={false}
                                    custom={direction}
                                    mode="popLayout"
                                ...
                                <div className="absolute bottom-6 right-6 md:bottom-8 md:right-8 flex gap-2 md:gap-3 z-20">
                                    <button
                                        ...
                                        className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gray-800 backdrop-blur-md border border-gray-700 flex items-center justify-center text-white hover:bg-gray-700 transition-all active:scale-90"
                                        aria-label="Previous"
                                    >
